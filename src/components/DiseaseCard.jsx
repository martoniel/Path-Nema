  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between mb-5">
        <div className="w-[46px] h-[46px] rounded-xl bg-[rgba(46,255,192,0.1)] border border-[#1aad82] flex items-center justify-center overflow-hidden">
          <DiseaseEyeIcon name={disease.name} size={40} />
        </div>
